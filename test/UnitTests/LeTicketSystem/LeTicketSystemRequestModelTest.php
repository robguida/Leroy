...
{
    public function testTicketSystemRequestModelInstantiationWithDescriptionAsAnArray()
    {
    ...
    public function testTicketSystemRequestModelInstantiationWithDescriptionAString()
    {
        $model = new LeTicketSystemRequestModel();
        $title = 'Model Test 1';
